...
export default function ValuesSection() {
 ...
 return (
  <section id="values" className="container mx-auto px-2 sm:px-4 md:px-8 py-8 sm:py-12 md:py-16 w-full max-w-full overflow-x-hidden scroll-mt-24">
   <div className="max-w-7xl mx-auto bg-card rounded-xl sm:rounded-2xl md:rounded-3xl p-4 sm:p-6 md:p-8 lg:p-12 border border-border/60 dark:border-white/20  shadow-lg hover:shadow-xl transition-all duration-300 my-4 sm:my-6 md:my-8">
    ...
    <div className="relative text-center mb-6 sm:mb-8 md:mb-12">
     <h2 className="text-lg sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold mb-2 sm:mb-3 md:mb-4 text-foreground px-2">Değerlerimiz</h2>
     ...
     {values.map((value) => {
      ...
      return (
       ...
       >
        ...
        <p className="relative text-xs sm:text-sm md:text-base lg:text-lg text-muted-foreground leading-relaxed">{value.description}</p>
       </div>
      );
     })}
    </div>
