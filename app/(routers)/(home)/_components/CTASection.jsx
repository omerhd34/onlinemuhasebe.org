...
export default function CTASection() {
 ...
 const [text1, setText1] = useState("Profesyonel ekibimiz, işletmenizin mali süreçlerini optimize etmek için hazır. Hemen iletişime geçin, size özel çözümler sunalım.");
